...
int main() {
    ...
    cout << "Collatz Multi-threaded V4 - Reduction Optimization" << endl;
    cout << "===================================================" << endl;
    cout << "Start: 2^71 = "; print_uint128(START); cout << endl;
    cout << "Range: " << COUNT << " numbers" << endl;
    cout << "Threads: " << NUM_THREADS << endl;
    cout << "Optimizations: Mod-6 + OpenMP reduction (no critical section)" << endl << endl;
    ...
    // Use OpenMP reduction to eliminate critical section
    #pragma omp parallel reduction(+:total_steps,numbers_tested,cycles_found)
    {
        ...
        // Only need critical section for max_steps (can't reduce __uint128_t)
        #pragma omp critical
        {
